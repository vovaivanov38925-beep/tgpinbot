      ...
      <main className="max-w-lg mx-auto px-4 pt-4 flex-1 overflow-hidden flex flex-col">
        <Tabs defaultValue="pins" className="w-full flex-1 flex flex-col overflow-hidden">
          <TabsList className="w-full bg-muted/30 shrink-0 flex gap-2 p-2 rounded-2xl">
            <TabsTrigger value="pins" className="flex-1 data-[state=active]:bg-primary data-[state=active]:text-white rounded-xl transition-all flex flex-col items-center py-3 gap-1.5">
              <PinIcon className="w-6 h-6" />
              <span className="text-sm font-semibold">Пины</span>
            </TabsTrigger>
            <TabsTrigger value="tasks" className="flex-1 data-[state=active]:bg-violet-500 data-[state=active]:text-white rounded-xl transition-all flex flex-col items-center py-3 gap-1.5">
              <ListTodo className="w-6 h-6" />
              <span className="text-sm font-semibold">Задачи</span>
            </TabsTrigger>
            <TabsTrigger value="progress" className="flex-1 data-[state=active]:bg-amber-500 data-[state=active]:text-white rounded-xl transition-all flex flex-col items-center py-3 gap-1.5">
              <Trophy className="w-6 h-6" />
              <span className="text-sm font-semibold">Прогресс</span>
            </TabsTrigger>
            <TabsTrigger value="premium" className="flex-1 data-[state=active]:bg-gradient-to-r data-[state=active]:from-pink-500 data-[state=active]:to-violet-500 data-[state=active]:text-white rounded-xl transition-all flex flex-col items-center py-3 gap-1.5">
